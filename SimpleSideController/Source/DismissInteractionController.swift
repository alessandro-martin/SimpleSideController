...
class DismissInteractionController: UIPercentDrivenInteractiveTransition {
    ...
    init(simpleSideController: SimpleSideController) {
        ...
        simpleSideController.presentAnimationController?.transitionView?.addGestureRecognizer(simpleSideController.panGestureRecognizer!)
    }
    ...
    @objc fileprivate func handleSwipeGesture(gr: UIPanGestureRecognizer) {
        ...
        case .began:
            ...
            simpleSideController._state = .front
        case .changed:
